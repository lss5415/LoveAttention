...
//	List<Map<String, String>> data = new ArrayList<Map<String, String>>();
	...
	public JieSuanAdapter(Activity context) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView==null){
			...
			convertView=LinearLayout.inflate(context, R.layout.querendingdanlist, null);
...
//			ViewHolder.tv_a3_address=(TextView) convertView.findViewById(R.id.tv_a3_address);
		...
		adapter = new JieSuanListAdapter(context);
		ViewHolder.al_shangpinlist.setAdapter(adapter);
