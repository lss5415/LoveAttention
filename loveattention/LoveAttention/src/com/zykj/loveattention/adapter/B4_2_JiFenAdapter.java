...
public class B4_2_JiFenAdapter extends BaseAdapter {
	private Context context;
	List<Map<String, String>> data = new ArrayList<Map<String, String>>();

	public B4_2_JiFenAdapter(Context context,List<Map<String, String>> data) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if(convertView==null){
			...
			convertView=LinearLayout.inflate(context, R.layout.b4_2_item, null);
