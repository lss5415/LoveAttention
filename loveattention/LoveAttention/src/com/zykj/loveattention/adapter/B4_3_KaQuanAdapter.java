...
//		ViewHolder.rl_shang.setBackgroundColor(android.graphics.Color.parseColor("#F39292"));
		...
		convertView.setOnClickListener(new getDetail(couponname, name, effecttime,couponintroduct));
		return convertView;
	}
	/**
	 * 跳转到卡券详情
	...
	class getDetail implements View.OnClickListener {
		String couponname,name,effecttime,couponintroduct;
		public getDetail(String couponname,String name,String effecttime,String couponintroduct) {
