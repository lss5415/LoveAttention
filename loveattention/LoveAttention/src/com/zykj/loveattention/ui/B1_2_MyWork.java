...
public class B1_2_MyWork extends BaseActivity {
	...
	private void initView() {
		...
		setListener(btn_back, btn_jinrong, btn_it, btn_meiti, btn_canyin,
				btn_lingshou, btn_jiaoyu, btn_xuesheng, btn_yiyao, btn_liren1,
				btn_fuwuye, btn_ziyouzhiye, btn_zhizaoye, btn_next1);
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_next1:
			...
			if (total_of_ischosed > 1) {
				...
				// it4next.putExtra("gongzuo", "16");
				// it4next.putExtra("xingqu",
				// getIntent().getStringExtra("xingqu"));
				// startActivity(it4next);

				Intent it4next = new Intent();
				it4next.setClass(this, B1_2_MyLifeState.class);
				it4next.putExtra("gongzuo", "16");
				it4next.putExtra("xingqu", getIntent().getStringExtra("xingqu"));
